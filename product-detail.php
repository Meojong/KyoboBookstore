...
<body class="animsition">
	...
	<?php if (isset($_SESSION['id'])) {
		echo '
		function buy(){
				location.href="purchase.php?customer='.$_SESSION['id'].'&no='.$_GET['no'].'&quantity=" + document.getElementById("quantity").value + "&title=" + document.getElementById("b_title").innerText;
			}
			';}
			else {
				echo 'function buy(){
		...
		<div class="flex-w flex-sb">
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
						<div class="item-slick3" data-thumb="<?= $row['thumb']?>">
					...
					<div class="flex-r-m flex-w p-t-150">
						<div class="w-size16 flex-m flex-w">
							...
							<div class="btn-addcart-product-detail size9 trans-0-4 m-t-10 m-b-10">
								<!-- Button -->
								<button class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" onclick="buy();">
									구매하기
								</button>
							</div>
